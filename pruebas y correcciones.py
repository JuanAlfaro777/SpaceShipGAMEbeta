...
# Crear meteoritos
meteor_type = 1  # Inicia con el tipo de meteorito 1
...
# Función para cambiar el tipo de meteorito
def change_meteor_type():
    global meteor_type
    meteor_type += 1
    if meteor_type > 4:
        meteor_type = 1
...
while running:
    ...
    # Cambiar el tipo de meteorito al alcanzar los 50 puntos
    if score % 50 == 0:
        change_meteor_type()
